...
has no functionality in actual app
delete later
...
class PopupFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<TextView>(R.id.textViewPopup).setOnClickListener { Navigation.findNavController(view).navigate(R.id.action_popupFragment_to_homeFragment) }
